...
12. Puntos a mejorar.
13. Barreras de escalabilidad y coste de cambio.
...
7. Ejecutar `base-architecture-guard` si el modulo tiene una pieza sensible o un hotspot claro.
8. Sintetizar hallazgos tecnicos y de producto.
9. Persistir con `base-document-project` en `Analysis.md` y `DataMap.md`.
10. Si el analisis descubre criterios que aceleren futuras auditorias del mismo contexto, promoverlos a `Memory/AnalysisMemory.md`.
