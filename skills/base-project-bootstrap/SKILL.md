...
7. Hacer lectura arquitectonica inicial si la tarea no es trivial:
- limites entre capas o piezas
- hotspots o zonas monoliticas
- responsabilidades mezcladas
- zonas fragiles donde un cambio pequeno podria romper mucho
- partes donde conviene aislar responsabilidades antes de ampliar comportamiento

8. Si la tarea incluye diseno, planificacion o cambios no triviales, llamar a `base-architecture-guard`.

9. Resumir antes de actuar:
- Que se va a tocar.
- Que skills base aplican.
- Que restricciones tecnicas y de negocio mandan.
- Que contexto formal existe y cual falta.
- Que riesgos estructurales o de escalabilidad se han detectado.
...
- Si en el arranque ya se detecta un hotspot monolitico o una frontera difusa, debe quedar explicitado antes de planificar o desarrollar.
